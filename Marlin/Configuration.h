...
// Travel limits (mm) after homing, corresponding to endstop positions.
  ...
  #define BLTOUCH
  #define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH  //false   // BLTouch
...
// Travel limits (mm) after homing, corresponding to endstop positions.
  ...
  #define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH  // short end mill to ground
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {16*24.8139,16*24.8139,256*24.8139,256*48.875}
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK  0.5   // whole machine jerks at default rates
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP     115    // (°C) Default bed temperature for G26.
