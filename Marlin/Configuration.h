...
// Choose the name from boards.h that matches your setup
 ...
 //   #ifdef LED_PIN
 //     #undef LED_PIN                          // Can't use default of PA13 if wanting to do SWD debugging
 //   #endif
 //   #define LED_PIN                             PD15    // hijack FAN5 connector
 //   #ifdef FAN5_PIN
 //     #undef FAN5_PIN
 //   #endif
  #endif
...
#define HEATER_0_MAXTEMP 285  // PT100:285, PT1000:295
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // TEVO little monster smart effector (no overshoot but tends to throw heater errors if start above 200C)
    //#define DEFAULT_KP 25
    //#define DEFAULT_KI 3
    //#define DEFAULT_KD 500

    // TEVO little monster smart effector (from M303 auto tune)
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 16.2f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.0741f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1140f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  ...
  #define FILAMENT_HEAT_CAPACITY_PERMM { 0.00515f }    // 0.0056 J/K/mm for 1.75mm PLA (0.0149 J/K/mm for 2.85mm PLA).
...
#define DELTA
  ...
  #define DELTA_HEIGHT 486.38             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ {0,-0.4, -0.86} // {  -0.71 , +0.00, -0.67}  // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 166.2              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.31 , 0.42, -0.11} // {  -0.71 , +0.00, -0.67}  } // (mm) Get these values from G33 auto calibrate
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 25 }  // from default config
//#define DEFAULT_MAX_FEEDRATE           { 20000, 20000, 20000, 10000 } // { 666.67, 666.67, 666.67, 1000 } // works but is SLOW  // { 250, 250, 250, 250 }    // { 250, 250, 250, 500 }   { 200, 200, 200, 1000 } // { 20000, 20000, 20000, 1000 } // { 666.67, 666.67, 666.67, 1000 }  // { 200, 200, 200, 1000 } //
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 9000, 10000 }  // from default config
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 30  // black OK with 15 but blue not  // 7 was giving false errors
