...
#define STRING_CONFIG_H_AUTHOR CUSTOM_MACHINE_NAME // Who made the changes.
...
//from M303 S230 C8 Autotune
 #define  DEFAULT_Kp 22.56  // 14 OCT 2018
 #define  DEFAULT_Ki 1.16   // 14 OCT 2018
 #define  DEFAULT_Kd 91.30  // 14 OCT 2018
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {16*24.8139,16*24.8139,256*24.8139,256*48.875}  // 16 microsteps on all
...
#define DEFAULT_MAX_FEEDRATE         {12, 12, 7, 5}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 75, 75, 75, 75}
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK .5   // whole machine jerks at default rates
...
#define INVERT_X_DIR true    // positive is away from the motor  A4988



#define INVERT_Y_DIR true    // positive is towards the motor  A4988
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
   #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP     115    // (°C) Default bed temperature for the G26 Mesh Validation Tool.
...
//  #define GRID_MAX_POINTS_X 5       // Don't use more than 15 points per axis, implementation limited.
  ...
  #define UBL_Z_RAISE_WHEN_OFF_MESH 20 // When the nozzle is off the mesh, this value is used
