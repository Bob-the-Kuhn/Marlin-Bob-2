...
// BD interface
//
#define  I2C_BD_SDA_PIN    PB7     // using BLTouch interface
#define  I2C_BD_SCL_PIN    PB6
...
#define Z_STEP_PIN                           PE6   // MOTOR 7
#define Z_DIR_PIN                            PA14
