 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        60 // Seconds  //random M112 bed thermal faults so try increasing from 30 to 60
...
#define DIGIPOT_MCP4451
   ...
   * MKS_SBASE             0x2C (0x58)       0x2E (0x5C)       MCP4451
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 2.8    // Unit: mm compression per 1mm/s extruder speed
