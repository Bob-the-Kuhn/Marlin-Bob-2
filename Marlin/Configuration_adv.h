...
#define EXTRUDER_AUTO_FAN_SPEED 255 // 192   // 255 == full speed
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 2.8         // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
